 ...
 /* define the winner pattern
    ...
    */
    const uint32_t CELL_MASK[9]={
      0b110000000000000000,  0b001100000000000000,  0b000011000000000000,
      0b000000110000000000,  0b000000001100000000,  0b000000000011000000,
      0b000000000000110000,  0b000000000000001100,  0b000000000000000011
    };
    // use for test empty position
    const uint32_t SET_CELL_HOST[9]={
      0b010000000000000000,  0b000100000000000000,  0b000001000000000000,
      0b000000010000000000,  0b000000000100000000,  0b000000000001000000,
      0b000000000000010000,  0b000000000000000100,  0b000000000000000001
    };
    const uint32_t SET_CELL_CHALLENGER[9]={
      0b100000000000000000,  0b001000000000000000,  0b000010000000000000,
      0b000000100000000000,  0b000000001000000000,  0b000000000010000000,  
      0b000000000000100000,  0b000000000000001000,  0b000000000000000010
    };
